...
export class EmpresasDataSource extends DataSource<EmpresasItem> {
  ...
  constructor(dataEmpresas: EmpresasItem[]) {
    super();
    this.data = dataEmpresas;
  }
  ...
  private getSortedData(data: EmpresasItem[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        case 'nombre': return compare(a.razon_social, b.razon_social, isAsc);
        case 'id': return compare(+a.id, +b.id, isAsc);
        case 'apellido': return compare(a.cuit, b.cuit, isAsc);
        default: return 0;
      }
    });
  }
